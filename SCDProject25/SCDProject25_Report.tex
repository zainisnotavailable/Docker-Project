...
\begin{titlepage}
    ...
    {\Huge\textbf{SCD Project 25}\\[0.5cm]}
    {\LARGE\textbf{Docker Deployment Report}\\[2cm]}
    
    \vfill
    
    {\Large\textbf{Submitted By:}\\[0.5cm]}
    {\large Zain Ali Khan\\[0.3cm]}
    {\large 22i-2624\\[0.3cm]}
    {\large BS Software Engineering\\[0.3cm]}
    {\large Batch 22\\[2cm]}
    
    {\Large\textbf{Institution:}\\[0.5cm]}
    {\large FAST NUCES Islamabad\\[2cm]}
